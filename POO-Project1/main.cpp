...
void Student :: afis_nume(Student & s) {cout << "Nume: "<<  s.nume << endl ; }
void Student :: afis_an_nastere(Student & s) {cout << "An nastere: " << s.an_nastere << endl ; }
void Student :: afis_numar_credite(Student & s) {cout << "Numar credite: " << s.numar_credite << endl ; }
void Student :: afis_media_generala(Student & s) {cout << "Media Generala: " << s.media_generala << endl ; }

void Student :: set_nume(Student & s) {cout << "Nume " << endl ; cin >> s.nume ; }
void Student :: set_an_nastere(Student & s) {cout << "An Nastere " << endl ; cin >> s.an_nastere ; }
void Student :: set_numar_credite(Student & s) {cout << "Numar credite: " << endl ; cin >> s.numar_credite ; }
void Student :: set_media_generala(Student & s) {cout << "Medie Generala " <<  endl ; cin >> s.media_generala ; }
